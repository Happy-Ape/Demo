	...
	function tbodyslis(data){
		...
		$("#tbodybox").hide();
				...
				for(var i=0;i<data.lists.length;i++){
					...
					html+='</td><td>';
					if(state==0){
						html+='<span class="removebtn">删除</span><a href="buysmessage.html?type=';
						html+=data.lists[i].userNeedId;
						html+='"><span>修改</span></a>';
					};
					if(state==1){
						html+='<span class="offbtn">下架</span><span class="removebtn">删除</span><a href="buysmessage.html?type=';
						html+=data.lists[i].userNeedId;
						html+='"><span>修改</span></a>';
					};
					if(state==-1){
						html+='<span class="onbtn">上架</span><span class="removebtn">删除</span><a href="buysmessage.html?type=';
						html+=data.lists[i].userNeedId;
						html+='"><span>修改</span></a>';
					};
					if(state==-2){
