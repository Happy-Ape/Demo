...
function addIframe(cur){
	...
	if (!isHas) {
		var tab = "<a href='javascript:;' class='content-tab active' data-id='"+h+"'>"+ label +" <i class='icon-font'>&#x1006;</i></a>";
	...
	for(var i=0; i<menu.length; i++){   
		...
		try{
			if(item.isHeader == "1"){
				...
				item.icon == "" ? item.icon = "&#xe638" : item.icon = item.icon;
				if(item.childMenus == ""){
...
function getMathColor(){
	...
	for(var i=0;i<le;i++){
		...
		//$(".menu-item > ul > li > a").eq(i).find("i:first").css("color",color);
		$(".menu-item-child").find("i").css("color","#e53935");
	}
}
...
$(function(){
	...
	var menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"3","name":"商品相关管理","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"4","name":"商品分类管理","parentId":"3","url":"producttype2.html","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"5","name":"商品列表管理","parentId":"3","url":"productlist.html","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"6","name":"注册用户管理","parentId":"3","url":"userlist.html","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"7","name":"订单列表管理","parentId":"3","url":"orderlist.html","icon":"","order":"1","isHeader":"0","childMenus":""}
					]}
					]
				}
